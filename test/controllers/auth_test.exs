defmodule Rumbl.AuthTest do
  ...
  test "call places uer from session into assigns", %{conn: conn} do
    user = insert_user()
    conn =
      conn
  ...
  test "call with no sessions ets current_user assign to nil", %{conn: conn} do
  ...
  test "login with password mismatch", %{conn: conn} do
    ...
    assert {:error, :unautorized, _conn} =
